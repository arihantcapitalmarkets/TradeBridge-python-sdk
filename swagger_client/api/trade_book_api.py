...
class TradeBookApi(object):
    ...
    def trade_book(self, authorization, api_key, source):  # noqa: E501
        """Trades  # noqa: E501
        ...
        """
        (data) = self.trade_book_with_http_info(authorization, api_key, source)  # noqa: E501
        return data

    def trade_book_with_http_info(self, authorization, api_key, source):  # noqa: E501
        """Trades  # noqa: E501
        ...
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError(
                "Missing the required parameter `authorization` when calling `trade_book`")  # noqa: E501
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `trade_book`")  # noqa: E501
        if ('source' not in params or
                params['source'] is None):
        ...
        return self.api_client.call_api(
            '/wrapper-service/api/order/v1/trade-book', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
