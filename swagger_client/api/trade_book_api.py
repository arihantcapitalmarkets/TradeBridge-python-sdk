...
class TradeBookApi(object):
    ...
    def get_order_book(self, authorization, api_key):  # noqa: E501
        ...
        """
        (data) = self.get_order_book_with_http_info(authorization, api_key)  # noqa: E501
        return data

    def get_order_book_with_http_info(self, authorization, api_key):  # noqa: E501
        """Get orders  # noqa: E501
    ...
    # Order Trail
    def order_trail(self, body, authorization, api_key):  # noqa: E501

        (data) = self.order_trail_with_http_info(body, authorization, api_key)  # noqa: E501
        return data

    def order_trail_with_http_info(self, body, authorization, api_key):
    ...
    def trade_book(self, authorization, api_key):  # noqa: E501
        """Trades  # noqa: E501
        ...
        """
        (data) = self.trade_book_with_http_info(authorization, api_key)  # noqa: E501
        return data

    def trade_book_with_http_info(self, authorization, api_key):  # noqa: E501
        """Trades  # noqa: E501
    ...
    def order_status(self, body, authorization, api_key):  # noqa: E501

        (data) = self.order_status_with_http_info(body, authorization, api_key)  # noqa: E501
        return data

    def order_status_with_http_info(self, body, authorization, api_key):
